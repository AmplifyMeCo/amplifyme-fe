      ...
      <div className="container">
          <div className="wrapper">
              ...
              <div className="form-header">
                  ...
                  <input id="fname" name="fname" type="text" placeholder="First Name" onChange={handleChange} />
                  <input id="lname" name="lname" type="text" placeholder="Last Name" onChange={handleChange} />
                  </div>
                  <div className="form-bottom">
                      <input id="organization" name="organization" type="text" placeholder="Organization Name" onChange={handleChange} />
                      <input id="email" name="email" type="text" placeholder="Email" onChange={handleChange} />
                      <input id="password" name="password" type="password" placeholder="New Password"  onChange={handleChange} />
                  </div>
                      <div className="label">
                          <p>Date Of Birth</p>
                      </div>
